        ...
        <section className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
          <div className="mb-8">
            ...
            <p className="mt-3 text-sm text-gray-600">
              These terms explain the subscription, data retention, and compliance rules for
              using this point of sale platform.
            </p>
          </div>
          ...
          <div className="space-y-8 text-sm leading-6 text-gray-700">
            ...
            <section>
              ...
              <p className="mt-2">
                ...
                audit events, and financial order records required for legal or tax retention are
            ...
            <section>
              ...
              <p className="mt-2">
                By creating an account, the tenant owner accepts this Terms version on behalf of
                the business. The platform records the accepted version, timestamp, IP address, and
          ...
          <div className="mt-10 border-t border-gray-200 pt-6">
            <Link href="/signup" className="text-sm font-medium text-primary-600 hover:text-primary-500">
              Back to signup
            </Link>
          </div>
        </section>
