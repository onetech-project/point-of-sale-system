...
- [ ] T020 [P] Create a PR for branch `004-order-notifications` containing spec, plan, contracts, and initial implementation tasks (`git push && gh pr create` or equivalent) — include reviewers from backend/frontend/ops.
